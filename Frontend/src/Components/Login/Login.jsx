    ...
    <div className='loginPage flex'>
      <div className="container flex">
        ...
        <div className="textDiv">
          <h2 className='title'>ERP For Constructiont Thailand</h2>
          <p>By Woo You Creative <i class="fa fa-creative-common" aria-hidden="true"></i></p>
        </div>

        <div className="footerDiv flex">
          <span className="text">สมาชิกใหม่หากยังไม่มี Accout</span>
          <Link to={'/register'}>
        ...
        <div className="formDiv flex">
          <div className="headerDiv">
            <img src={logo} alt="Logo Image" style={{ width: '200px',height: 'auto'}} />
